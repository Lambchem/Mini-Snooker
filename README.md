...
A lightweight browser-based snooker game built with **HTML5 Canvas**, **CSS**, and **vanilla JavaScript**. \textbf{The game is in Chinese, but I'm glad someone could translate it into English}.
